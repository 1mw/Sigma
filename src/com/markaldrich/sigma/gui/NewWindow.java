...
public class NewWindow {
	...
	public static final String[] types = { "Variable", "Method", "Statement", };
	public static final String[] defaultTypes = { "int", "String", "double", "float", "long", "char", };
		...
		btnOk_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(txtNameMethod.getText().equals("") || txtNameMethod.getText() == null
						|| comboReturn.getSelectedItem().toString().equals("")
						|| comboReturn.getSelectedItem() == null) {
					Toolkit.getDefaultToolkit().beep();
					return;
				}

				if(txtParameterTypeMethod.getText().contains("Leave blank for no parameter")) {
				} else {
			...
			public void actionPerformed(ActionEvent e) {
				...
				for(SigmaImport im : MainWindow.script.imports) {
					if(im.toImport.equals(importName.getText())) {
						Toolkit.getDefaultToolkit().beep();
						JOptionPane.showMessageDialog(importPanel, "Import already exists.", "Error",
